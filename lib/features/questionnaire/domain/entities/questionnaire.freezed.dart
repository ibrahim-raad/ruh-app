...
mixin _$Questionnaire {
 ...
 String get id; QuestionnaireType get type; String get title; String? get description;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Questionnaire&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description));
}
...
@override
String toString() {
  return 'Questionnaire(id: $id, type: $type, title: $title, description: $description)';
}
...
@useResult
$Res call({
 String id, QuestionnaireType type, String title, String? description
});
...
as QuestionnaireType,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  QuestionnaireType type,  String title,  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Questionnaire() when $default != null:
return $default(_that.id,_that.type,_that.title,_that.description);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  QuestionnaireType type,  String title,  String? description)  $default,) {final _that = this;
switch (_that) {
case _Questionnaire():
return $default(_that.id,_that.type,_that.title,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  QuestionnaireType type,  String title,  String? description)?  $default,) {final _that = this;
switch (_that) {
case _Questionnaire() when $default != null:
return $default(_that.id,_that.type,_that.title,_that.description);case _:
  return null;
...
class _Questionnaire implements Questionnaire {
  const _Questionnaire({required this.id, required this.type, required this.title, this.description});
  factory _Questionnaire.fromJson(Map<String, dynamic> json) => _$QuestionnaireFromJson(json);

@override final  String id;
@override final  QuestionnaireType type;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Questionnaire&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description));
}
