...
mixin _$RegisterDto {
 ...
 String get email; String get password;@JsonKey(name: 'full_name') String get fullName; String get role;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RegisterDto&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.role, role) || other.role == role));
}
...
@override
String toString() {
  return 'RegisterDto(email: $email, password: $password, fullName: $fullName, role: $role)';
}
...
@useResult
$Res call({
 String email, String password,@JsonKey(name: 'full_name') String fullName, String role
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  String password, @JsonKey(name: 'full_name')  String fullName,  String role)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  String password, @JsonKey(name: 'full_name')  String fullName,  String role)  $default,) {final _that = this;
switch (_that) {
case _RegisterDto():
return $default(_that.email,_that.password,_that.fullName,_that.role);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  String password, @JsonKey(name: 'full_name')  String fullName,  String role)?  $default,) {final _that = this;
switch (_that) {
case _RegisterDto() when $default != null:
return $default(_that.email,_that.password,_that.fullName,_that.role);case _:
  return null;
...
class _RegisterDto implements RegisterDto {
  const _RegisterDto({required this.email, required this.password, @JsonKey(name: 'full_name') required this.fullName, this.role = 'PATIENT'});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RegisterDto&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.role, role) || other.role == role));
}
